...
```text
 ...
 Build Spring Boot              Build Angular
      │                                 │
      └───────────────┬─────────────────┘
                      │
...
La documentation technique complète accompagne ce dépôt.

Elle contient notamment :

- les étapes de mise en œuvre du pipeline CI/CD ;
- le plan de conteneurisation ;
- le plan de déploiement ;
- le plan de testing périodique ;
- les métriques DORA ;
- les KPI ;
- l'analyse SonarCloud ;
- le plan de sécurité ;
- le plan de sauvegarde ;
- le plan de mise à jour.
